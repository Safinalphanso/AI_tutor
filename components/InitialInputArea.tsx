...
const InitialInputArea: React.FC<InitialInputAreaProps> = ({
  ...
  return (
    <div className="flex items-center justify-between space-x-2 bg-white/10 backdrop-blur-lg border border-white/0 rounded-3xl p-1 shadow-lg w-full max-w-[800px]">
      ...
      <select
        id="grade"
        name="grade"
        className="h-full w-[200px] rounded-lg border border-gray-300 bg-transparent px-2 py-1 text-gray-100 shadow-lg transition-all duration-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
        value={ageGroup}
      ...
      <button
        ...
        className="flex items-center rounded-full bg-purple-600 py-2 px-4 text-white transition-all hover:bg-blue-700"
      >
